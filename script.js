...
//Bottom validation
let bottomParagraph = document.getElementById("paragraph2");
let bottomEmailValidation = document.querySelector(".validation2").value.trim();
let bottomEmailDesign = document.querySelector(".validation2");
let buttomButton = document.querySelector(".button2");
function validation2() {
    if (bottomEmailValidation == "") {
        bottomParagraph.innerText = "Email require.";
        bottomEmailDesign.style.border = "2px solid red";
    }
}
buttomButton.addEventListener("click", () => {
    validation2();
})
